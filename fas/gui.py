...
import fas.core as core
import fas.gui_help as gui_help
import fas.gui_category as gui_category
...
class FileGrouperWindow(wx.Frame):
    ...
    def __init__(self, *args, **kw):
        ...
        label_attention = wx.StaticText(pnl, label="File Associations and Sorter")
